...
FAMILY_BLURB = {
    "aniso": (
        ...
        "rank climbs like N^0.5 while a patched representation is held at its "
        "per-patch cap by construction; the geometric bound of the bit count also "
        "grows like sqrt(N) as R follows the box, so this is a contest of growth "
        "rates rather than a wall. The isotropic control of the same "
