...
export BENCH_PATCH_ONLY=1 BENCH_PATCH_LAYOUTS=balanced_xyz,shared_y_only
export BENCH_SKIP_REFERENCE_COUNT=1
...
for input_rtol in 1e-8 1e-9 1e-10; do
  run_point 12000 "$input_rtol"
done
