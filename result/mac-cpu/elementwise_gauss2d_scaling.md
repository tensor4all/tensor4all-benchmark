...
|---|---|---|---|
| aci | 4 | 2.62 | 2.20e-08 |
| fit_treetn | 4 | 2.63 | 1.09e-08 |
| zipup_treetn | 4 | 2.85 | 9.28e-01 |
...
Fitted over this sweep, chi_in grows like N^x with x = 0.28, against x = 0.5 for the sqrt(N) hypothesis and x = 1 for the linear one.
