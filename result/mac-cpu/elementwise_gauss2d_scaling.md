...
|---|---|---|---|
| aci | 4 | 3.00 | 1.53e-08 |
| fit_treetn | 4 | 3.55 | 1.25e-08 |
| zipup_treetn | 4 | 3.62 | 5.67e-01 |
...
Fitted over this sweep, chi_in grows like N^x with x = 0.29, against x = 0.5 for the sqrt(N) hypothesis and x = 1 for the linear one.
